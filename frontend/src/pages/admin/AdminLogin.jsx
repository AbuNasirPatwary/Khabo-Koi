...
import { loginPlatformAdmin } from '../../api/adminApi'
  ...
  return (
    <main className="min-h-screen bg-[#f7f2e9] lg:grid lg:grid-cols-2">
      <section className="relative min-w-0 overflow-hidden bg-[#1a2332] px-7 py-10 text-white sm:px-12 lg:flex lg:min-h-screen lg:flex-col lg:justify-between lg:px-16 lg:py-14">
        ...
        <div className="absolute -bottom-32 -left-20 h-96 w-96 rounded-full bg-blue-500/10 blur-3xl" />
        ...
        <div className="relative my-14 max-w-xl lg:my-0">
          ...
          <h1 className="mt-5 text-4xl font-bold leading-tight sm:text-5xl">
            Operate the dining platform with confidence.
          </h1>
          <p className="mt-6 max-w-lg text-base leading-7 text-slate-300">
            Review real platform activity, administer users, and control
            restaurant access from one secure workspace.
          </p>
        ...
        <p className="relative hidden text-xs text-white/35 lg:block">
          Authorized Khabo-Koi administrators only
        </p>
      </section>
      ...
      <section className="flex min-w-0 items-center justify-center px-6 py-12 sm:px-12 lg:px-16">
        <div className="w-full max-w-md">
          ...
          <p className="mt-3 text-sm leading-6 text-slate-500">
            Your credentials are verified first, followed by a server-side
          ...
          >
            ...
            <p className="mt-5 text-center text-xs leading-5 text-slate-400">
              Normal Customer and Restaurant Manager accounts cannot enter
              this portal.
            </p>
          </form>
